...
const Form = () => {
    ...
    const card = {
      userId: "cm08fuidt0000to4wrfk5w2xs", visitDate, clinicHospitalName, diagnosis, treatment
    }
		...
		<>
			<div className="Form">
				<form onSubmit={handleSubmit} className="text-xs m-5">
					<input
						className="bg-stone-50 mb-1 border-stone-200 border-[0.5px] rounded-md p-1 w-full"
						required
						type="text"
